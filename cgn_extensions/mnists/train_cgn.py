""" Copy of the cgn_framework/traing_cgn.py for training the text v color cgn"""
...
from cgn_framework.mnists.dataloader import get_dataloaders
from cgn_framework.mnists.models import DiscLin, DiscConv
from cgn_framework.utils import save_cfg, load_cfg, Optimizers
from shared.losses import BinaryLoss, PerceptualLoss

from models.txt_x_col_cgn import TxC_CGN
#### Train CGN ### ToDo
...
def main(cfg):
    # model init
    cgn = TxC_CGN(n_classes=cfg.MODEL.N_CLASSES, latent_sz=cfg.MODEL.LATENT_SZ,
...
if __name__ == "__main__":
    ...
    args.ignore_time_in_filename = False
