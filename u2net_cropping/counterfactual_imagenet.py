...
from cgn_framework.imagenet.generate_data_fake_cgn import main as generate_main
...
def main(n_data=6, generate_latex=True):
    seed_everything(19)
    args = generate_counterfactual(mode="best_classes", n_data=n_data, run_name="RUN_NAME", weights_path="",
    ...
    data_path = os.path.join('imagenet', 'data', 'cgn', 'fake_cgn', time_str + trunc_str) #TODO: change this one
    ...
    file_name = "qualitative_imagenet_u2cropping" #TODO: change this one
