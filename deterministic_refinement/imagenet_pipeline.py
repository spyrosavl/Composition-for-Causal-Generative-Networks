...
def train_classifier(args: dict = dict(lr=0.001), prefix="in-mini", seed=0, disp_epoch=45, show=False, ignore_cache=False):
    ...
    experiment_name = "deterministic_refinement" #TODO: Change this one
    ...
    for classifier in classifiers:
        for dataset in datasets:
            ...
            if classifier == "cgn-ensemble":
                weight_path = "cgn_framework/imagenet/experiments/classifier__in-mini-classifier-deterministic_refinement/model_best.pth" #TODO: Change this one
