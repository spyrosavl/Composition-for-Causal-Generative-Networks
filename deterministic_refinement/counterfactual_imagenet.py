...
from cgn_framework.imagenet.generate_data_deterministic_refinement import main as generate_main
...
def main(n_data=6, generate_latex=True):
    ...
    data_path = os.path.join('imagenet', 'data', 'cgn', 'deterministic_refinement', time_str + trunc_str) #TODO: change this one
    ...
    file_name = "qualitative_imagenet_deterministic_ref" #TODO: change this one
