...
from cgn_framework.imagenet.generate_data_deterministic_refinement_retrain import main as generate_main
...
def main(n_data=6, generate_latex=True):
    seed_everything(19)
    args = generate_counterfactual(mode="best_classes", n_data=n_data, run_name="RUN_NAME", weights_path="../cgn_framework/imagenet/experiments/cgn_2022_06_03_18_01_cgn_poisson/weights/ep_0015000.pth",
    ...
    data_path = os.path.join('imagenet', 'data', 'cgn', 'deterministic_refinement_retrain', time_str + trunc_str) #TODO: change this one
    ...
    file_name = "qualitative_imagenet_deterministic_retrain" #TODO: change this one
